...
def main():
    ...
    accs_NN_old = []
    accs_NN_old.append(model_eval(NT, model, snrdb_list[NT][0], snrdb_list[NT][-1], 500 , generator, 'cuda', iterations=500, test_set_flag = test_set_flag, test_set = H.repeat_interleave(1, dim= 0).double()))
    print(accs_NN_old)
